...
class MLPPolicyPG(MLPPolicy):
    ...
    def update(self, observations, actions, advantages, q_values=None):
        ...
        # DO: update the policy using policy gradient
        ...
        logpi = self(observations).log_prob(actions)

        policy_loss = -torch.mean((logpi * advantages))
        ...
        if self.nn_baseline:
            ## DO: update the neural network baseline using the q_values as
            ...
            baseline_loss = self.baseline_loss(q_values, self.baseline(observations))
